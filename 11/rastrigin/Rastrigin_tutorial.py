...
"""## Rastrigin Function  in dimension N
...
plt.legend()
plt.title("Rastrigin function with the DOE points and predicted values")

plt.savefig('Rastrigin function with the DOE points and predicted values.png')
...
plt.title(" Rastrigin Surrogate Model with the 99% confidence interval ")
plt.xlabel("x1")
plt.ylabel("x2")
plt.legend()
plt.savefig('Rastrigin Surrogate Model with the 99% confidence interva.png')
...
plt.title("Rastrigin surrogate model error")
plt.xlabel("x1")
plt.ylabel("x2")
plt.savefig('Rastrigin surrogate model error.png')
