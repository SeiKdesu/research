...
# Lossのプロット
plt.subplot(2, 1, 1)
plt.plot(range(1, len(accuracy) + 1), accuracy, label='Acc')
plt.xlabel('Epoch')
plt.ylabel('ACC')
...
# AUCのプロット
plt.subplot(2, 1, 2)
plt.plot(range(1, len(auc_values) + 1), auc_values, label='AUC', color='orange')
plt.xlabel('Epoch')
plt.ylabel('AUC')
...
# プロットをPNGとして保存
plt.tight_layout()
plt.savefig('training_loss_auc.png')
