...
G.add_node('Z1')
G.add_node('Z2')
G.add_edge('X1','Z1',weight=1)
G.add_edge('X2','Y1',weight=1)
G.add_edge('Z1','Z2',weight=1)
G.add_edge('Y2','X3',weight=1)
G.add_edge('Z2','Y3',weight=1)
G.add_edge('Z1','X2',weight=1)
G.add_edge('Z1','Y1',weight=1)
G.add_edge('Z2','X3',weight=1)
G.add_edge('Z2','Y2',weight=1)
