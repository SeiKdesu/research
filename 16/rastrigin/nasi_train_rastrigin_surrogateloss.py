...
def train(dt):
    ...
    pp5 = keep_indices_as_nonzero(pp, mal_list4)
    pp6 = keep_indices_as_nonzero(pp, mal_list5)
    all_prediction1 = predict_surrogate(pp1)
    all_prediction2 = predict_surrogate(pp2)
    all_prediction3 = predict_surrogate(pp3)
    all_prediction4 = predict_surrogate(pp4)
    all_prediction5 = predict_surrogate(pp5)
    all_prediction6 = predict_surrogate(pp6)
