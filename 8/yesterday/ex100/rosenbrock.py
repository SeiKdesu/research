...
def objective_function(x,dim):
    ...
    powell_value= trid(x[n_rosenbrock+n_dixon:n_rosenbrock+n_dixon+n_powell],n_powell)
...
for t in range(epochs):
    ...
    model.state_dict()['linear_relu_stack.0.weight'][0:92] = param_weight1
    model.state_dict()['linear_relu_stack.1.weight'][0:50] = param_weight2
    model.state_dict()['linear_relu_stack.2.weight'][0:30] = param_weight3
    model.state_dict()['linear_relu_stack.3.weight'][0:10] = param_weight4
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('data_driven_rosenbrock.png')
...
def weight():
    ...
    param_weight=torch.tensor(param_weight)
    param_weight=param_weight.view(3882,1)
    ...
    for i in range(50):
        num+=1
        row_indices.append(194)
  
    for i in range(30):
        num+=1
        row_indices.append(195)
    print(num)
    for i in range(10):
        num+=1
        row_indices.append(196)

   
    for i in range(93,143):
        j+=1
        col_indices.append(i)
    
    for i in range(143,173):
        j+=1
        col_indices.append(i)
    print(j)
    for i in range(173,183):
        j+=1
        col_indices.append(i)
    # print(num,j)
