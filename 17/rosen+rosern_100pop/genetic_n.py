...
class geneticalgorithm():
    ...
    def run(self):
        ...
        if self.convergence_curve==True:
            ...
            plt.title('rosen+rosen 6dim not devide')
            plt.savefig('rosen+rosern_6dim_not_devide_convergence.png')
            plt.close()
...
###############################################################################     
    def evaluate(self):
        ...
        self.temp = self.temp.reshape(-1,6)
...
global_best_pop, global_best_fitness = model.run()
ic(global_best_pop)
