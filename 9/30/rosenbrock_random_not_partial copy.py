...
def objective_function(x):
    ...
    rosen_value = Rosenbrock(x, n_rosenbrock,1)
...
def objective_function2(x,num):
    return Rosenbrock1(x,num,50)
# パラメータの設定
dim = 51
...
print(objective_function(best_individual))
import matplotlib.pyplot as plt
...
def plot_fitness_history(best_fitness_history, avg_fitness_history):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('opt_rosenbrock_random_not_partial.png')
